...
namespace TesteCliente.Persistencia.Repositorios.EFCore
{
    public class FabricaBancoTempoExecucaoEF : IDesignTimeDbContextFactory<TesteClienteContext>
    {
        ...
        {
            var opcoes = new DbContextOptionsBuilder<TesteClienteContext>().UseSqlServer("Server=localhost,1433;Initial Catalog=sqldb-testecliente;User ID=sa;Password=testeCliente1433; TrustServerCertificate=true; Trusted_Connection=false;").Options;
